...
public partial class MainWindow : Window
{
    ...
    private void StartButton_Click(object sender, RoutedEventArgs e)
    {
        ...
        {
            MessageBox.Show(Strings.MinimumTwoRobots, Strings.AppTitle, MessageBoxButton.OK, MessageBoxImage.Warning);
            return;
        }
    ...
    private void RenderBattleField()
    {
        ...
        foreach (var missile in battleField.Missiles)
        {
            ...
            BattleFieldCanvas.Children.Add(ellipse);
        }
        ...
        foreach (var robot in battleField.Robots.Where(r => r.IsAlive))
        {
            ...
            BattleFieldCanvas.Children.Add(robotEllipse);
            ...
            BattleFieldCanvas.Children.Add(turretLine);
        }
    }
